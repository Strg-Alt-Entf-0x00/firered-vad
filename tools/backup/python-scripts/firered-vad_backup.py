#!/usr/bin/env python3
"""
firered-vad-1.0.0_backup.py - create project backup zip and copy to central archive
Usage: python firered-vad-1.0.0_backup.py [--project-root PATH] [--archive-root PATH] [--exclude PATH ...] [--dry-run]
"""
...
def main() -> int:
    ...
    # Remove version number pattern (e.g., -1.0.0) from project name for backup filename
    import re
